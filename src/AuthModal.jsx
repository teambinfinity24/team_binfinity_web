...
const AuthModal = ({ isDark, onClose, onLogin }) => {
  ...
  const [isMapOpen, setIsMapOpen] = useState(false); // State for MapModal
  ...
  const handleSubmit = (e) => {
    ...
    setIsMapOpen(true); // Open the MapModal instead of closing AuthModal
  };
  ...
  return (
    <>
      {!isMapOpen ? (
        ...
        <MapModal onClose={() => window.location.href = "./LandingPage"} /> // Open MapModal
      )}
    </>
  );
};
